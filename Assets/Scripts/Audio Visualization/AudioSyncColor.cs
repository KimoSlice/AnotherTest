...
public class AudioSyncColor : AudioSyncer
{
	...
	public override void OnUpdate()
	{
		...
		m_mat.material.color = Color.Lerp(m_mat.material.color, restColor, restSmoothTime * Time.deltaTime);
	}
	...
	{
		Color _curr = m_mat.material.color;
